...
parser.add_argument('--model_path', type=str, default='/home/csunda2s/FutureGAN/data/mmnist-2/test', help='path to FutureGAN`s generator checkpoint')
...
parser.add_argument('--nc', type=int, default=1, help='number of input image channels, default=3')
parser.add_argument('--resl', type=int, default=64, help='frame resolution, default=64')
...
parser.add_argument('--batch_size', type=int, default=3, help='batch size at test time, change according to available gpu memory, default=3')
