...
# p100
parser.add_argument('--batch_size_table', type=dict, default={4:32, 8:16, 16:8, 32:4, 64:2}, help='batch size table:{img_resl:batch_size, ...}, change according to available gpu memory')
## dgx
